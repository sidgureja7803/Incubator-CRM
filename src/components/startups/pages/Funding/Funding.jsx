...
const Funding = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const incubatorResponse = await axios.get(`${config.api_base_url}/startup/incubatorfunding/`, {
        headers: { Authorization: `Bearer ${token}` },
      });

      const externalResponse = await axios.get(`${config.api_base_url}/startup/externalfunding/`, {
        headers: { Authorization: `Bearer ${token}` },
      });
