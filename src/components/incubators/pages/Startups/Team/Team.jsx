...
const Team = () => {
  ...
  // Get team members from the startup data
  const teamMembers = startup?.team || [];
      ...
      <div className="team-grid">
        {teamMembers.length === 0 ? (
          <div className="no-team">
            <p>No team members found for this startup.</p>
            <p>Team members will appear here once they're added.</p>
          </div>
        ) : (
            ...
            <div key={member.id || index} className="member-card">
              ...
              <div className="member-details">
                <div className="member-header">
                  <h3>Name: {member.name || "Kanishk Dadwal"}</h3>
                  <p className="designation">Designation: {member.designation || "Venture Lab"}</p>
                </div>
                <div className="member-contact">
                  <div className="contact-row">
                    <p className="email">
                      <span>Email:</span>
                      <span>{member.email || "kanishkdadwal@gmail.com"}</span>
                    </p>
                    <p className="phone">
                      <span>Phone No.:</span>
                      <span>{member.phone || "+91 9690602545"}</span>
                    </p>
                  </div>
                </div>
                <div className="social-links">
                  ...
                  <a href={member.twitter || "#"} target="_blank" rel="noopener noreferrer" className="social-icon twitter">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
